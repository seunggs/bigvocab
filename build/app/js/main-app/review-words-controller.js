...
(function () {
  ...
  var ReviewWordsCtrl = function ReviewWordsCtrl(WordsService, $stateParams, $moment, $timeout, Sm2Service, ConfigService, DictionaryService, TextConvertService, $sce, ngAudio, $q) {
    ...
    function pronunciationFallback(wordObj) {
      ...
      DictionaryService.getPronunciationMw(wordObj.word).then(function (pronunciationPaths) {
